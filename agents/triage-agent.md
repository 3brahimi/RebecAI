...
implementation: agents/triage-agent.py
schema: agents/triage-agent.schema.json
skills:
  - rebeca-tooling
---
...
Schema: `agents/triage-agent.schema.json` → `input` block.
...
Conforms to the canonical Error Envelope defined in `agents/legata-to-rebeca.md`:
