...
10. Return the output contract JSON to the coordinator (do not call artifact_writer - coordinator handles persistence).
11. On any failure emit Error Envelope.
